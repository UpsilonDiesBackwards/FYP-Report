\chapter{analysis idk where this should go yet}
...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{@{} L l l L @{}}
        ...
        \addlinespace
        APRIL \-- A Particle Runtime Interaction Library & C++ & None (CLI) & Lightweight, sufficient documenation \\
        \addlinespace
        OpenWave &  &  &  \\
        \bottomrule
    \end{tabularx}
...
Due to this project being a framework, it provides the user a more hands-on approach to creating the simulations. However alongside this,
it could be argued that the work that is required to create a simulation may not be as approachable for some developers, especially those not familiar with C++.

Furthermore, given the time it took to compile the samples, it could be argued that this project could be too slow to provide a developer with a fast, iterative development experience.

Finally, the lack of an interface may prove to be another barrier of entry for some developers, alongside the lack of visu

\subsubsection*{openwave (openwave-labs)}
lorem ipsum
\\
\textbf{Accessibility}
lorem ipsum
